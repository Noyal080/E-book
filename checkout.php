...
if(isset($_POST['order_btn'])){
   ...
   $address = mysqli_real_escape_string($conn, 'Address '. $_POST['flat'].', '. $_POST['street'].', '. $_POST['city']);
...
<section class="checkout">
   ...
   <form action="" method="post">
      ...
      <div class="flex">
         ...
         <div class="inputBox">
            <span>Address :</span>
            <input type="text" name="flat" required placeholder="e.g. Satungal">
         </div>
         <div class="inputBox">
            <span>Street Name:</span>
            <input type="text" name="street" required placeholder="e.g. Narayan basti">
         </div>
         <div class="inputBox">
            <span>city :</span>
         ...
         <div class="inputBox">
            <span>Province Number :</span>
            <input type="number" min=0 max=7 name="state" required placeholder="e.g 3">
         </div>
      </div>
